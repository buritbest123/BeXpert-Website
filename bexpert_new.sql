...
--
-- Database: bexpert
-- Generation Time: 2566-04-20 23:50:13.3000
-- -------------------------------------------------------------
...
CREATE TABLE `admin_info` (
  ...
  `username` varchar(50) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `fname` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `lname` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `email` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `phone` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `Address` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `bdate` date NOT NULL,
  `psw` varchar(255) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `role` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `expert` (
  ...
  `fname` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `lname` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `about` varchar(1000) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `edu_highschool` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `edu_uni` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `skills` varchar(400) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `license` varchar(200) COLLATE utf8mb3_slovenian_ci DEFAULT NULL,
  `email` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `linkedin` varchar(100) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `mobile_num` varchar(200) COLLATE utf8mb3_slovenian_ci NOT NULL,
  `pic_link` varchar(500) COLLATE utf8mb3_slovenian_ci DEFAULT NULL,
  `bg_link` varchar(500) COLLATE utf8mb3_slovenian_ci DEFAULT NULL,
  PRIMARY KEY (`id`)

...
INSERT INTO `admin_info` (`username`, `fname`, `lname`, `email`, `address`, `bdate`, `psw`)VALUES
('navaluck020','Navaluck','Duwa','tanushka.duwa@outlook.com','Bangkok','2003-09-01','Janice1234'),
('ramita018','Ramita','Deeprom','ramita.deeprom@gmail.com','Chonburi','2003-02-26','Tingting1234'),
('phawida057','Burit','Phungchuen','phawidabery@gmail.com','Suratthani','2003-02-04','Berry1234'),
('burit079','Burit','Sihabut','burit.sih@gmail.com','Chonburi','2002-11-27','Best1234'),
('suwiboon012','Suwiboon','Chamniwikaikangwan','suwiboon.cha@outlook.com','Hua-Hin','2002-03-28','Pond1234');
...
-- Inseting data into database
INSERT INTO `login_info` (`email`, `psw`)VALUES
('tanushka.duwa@outlook.com','Janice1234'),
('ramita.deeprom@gmail.com','Tingting1234'),
('phawidabery@gmail.com','Berry1234'),
('burit.sih@gmail.com','Best1234'),
('suwiboon.cha@outlook.com','Pond1234');
...
INSERT INTO `expert` (`fname`, `lname`,`about`,`edu_highschool`,`edu_uni`,`skills`,`license`,`email`, `linkedin`,`mobile_num`,`pic_link`,`bg_link`)VALUES
('Navaluck','Duwa',
...
NULL,'tanushka.duwa@outlook.com','https://www.linkedin.com/in/navaluckduwa/','0982618964','https://drive.google.com/uc?export=view&id=1rzSfO_M0B2pdBrRWPgrrNO89Z4e7rOve',NULL),


('Ramita','Deeprom', 'Ramita Deeprom (Tingting) a sophomore at the Faculty of ICT, Mahidol University, with a keen interest in Business Analyst
...
NULL,'ramita.deeprom@gmail.com','https://www.linkedin.com/in/ramita-deeprom-tingting','0866021559','https://drive.google.com/uc?export=view&id=1L93ySujh_CoF-RKcd_fn_lYKRJHYxI6O',NULL),

('Phawida','Phungchuen','Phawida Phungchuen (Berry) a sophomore at the Faculty of ICT, Mahidol University.She has a passion for programming 
...
NULL,'phawidabery@gmail.com','https://www.linkedin.com/in/phawida Phungchuen /','0832914888','https://drive.google.com/uc?export=view&id=1Kldb68Qs1Jg66yekVGhTUIRWvXmZkaCY%27',NULL),

('Burit','Sihabut','Burit Sihabut (Best) a sophomore at the Faculty of ICT, Mahidol University. He is a passionate software engineer who combines 
...
NULL,'burit.sih@gmail.com','https://www.linkedin.com/in/burit-sihabut-best/','0988396603','https://drive.google.com/uc?export=view&id=1kGC-zQpll7fLaMvZw7ZoJJWqe0CplsE2',NULL),

('Suwiboon','Chamniwikaikangwan','Suwiboon Chamniwikaikangwan (Pond) a sophomore at the Faculty of ICT, Mahidol University. He is an expert in graphic design where he had experience graphic design, video editing, web design, photography, short film production, streaming, and YouTube creation. Aside from that He has also developed valuable soft skill, programming, crirical thinking and public Speaking. His expected major is Multimedia',
...
NULL,'swbpond@gmail.com','https://www.linkedin.com/in/suwiboon/','0625488883','https://drive.google.com/uc?export=view&id=1366kzRVwQ3doo3OEjeHroJ0hGuXCN-Rt',NULL);
